...
public class PessoaFisicaExec extends JFrame{
	...
	public PessoaFisicaExec(){
		...
		btnSalvar.addActionListener(new ActionListener(){
			...
			if (rdbsexo[0].isSelected()) {
				...
				"Nome: " + txtNome.getText() +#13+
				"Endereço: " + txtEnd.getText() +#13+
				"Bairro: " + txtBairro.getText() +#13+
				"CEP: " + txtCep.getText() +#13+
				"Cidade: " + txtCidade.getText() +#13+
				"Estado: " + cmbEst.getSelectedItem().toString() +#13+
				"Telefone: " + txtTel.getText() +#13+
				"Celular: " + txtCel.getText() +#13+
				"RG: " + txtRg.getText() +#13+
				"CPF: " + txtCpf.getText() +#13+
				"Sexo: Masculino",
	...
	public static void main(String args[]){
		...
		try {
			...
			pessoafisicaJdbcDAO.salvar(cadpf);
			//alunosJdbcDAO.listar();
			//alunosJdbcDAO.alterar(cadpf);
